...
tasks {
    gwt {
        gwt.modules = listOf("com.gcgenome.lims.Request")
        minHeapSize = "1024M"
        maxHeapSize = "2048M"
        sourceLevel = "auto"
...
tasks.war {
    archiveFileName.set("panel-service-request.war")
...
tasks.register<Copy>("copyWebResources") {
    ...
    from(zipTree("build/libs/panel-service-request.war")) {
        include("**/*.js")
        include("**/*.css")
        include("*.html")
