...
public class HereditaryCollapseElement extends HTMLElementBuilder<HTMLDivElement, HereditaryCollapseElement> implements CollapseElement<HTMLDivElement> {
	public static HereditaryCollapseElement build(String id, long sample, String service) {
		return new HereditaryCollapseElement(div(), id, sample, service);
	}
	...
	private HereditaryCollapseElement(HTMLContainerBuilder<HTMLDivElement> e, String id, long sample, String service) {
	...
	@Override
	public HereditaryCollapseElement that() {
		return this;
	}
