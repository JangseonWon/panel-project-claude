...
@Service("CANCER-LIMS Stat ver.2")
public class LimsStatv2 implements Worker {
	...
	private static final Pattern SERIAL_PATTERN = Pattern.compile("^(((\\d{2}(?:OS-)*Cancer\\d{1,4})[-_]((\\d{8}-\\d{3}-\\d{4})|(?i)(positive))([^.]*?))[-_](((.+?)-(\\d{1,4}))|(\\d{2}(\\D+)\\d{1,4}?))?[-_](\\D{1,4}))$");
