...
@Service("BRCA-Depth ver.2")
public class Depthv1_1 extends DepthWorkerImpl {
	private static final Pattern FILE_NAME_PATTERN = Pattern.compile("^Depth_exon.merge.(I_(\\d{2}BRCA\\d{1,4})[-_](\\d{1,4})(([-_]\\d{2}(.*)[-_]\\d{1,4})|[-_]\\d{2}(\\D+)\\d{1,4})*.*[-_]((\\d{8}-\\d{3}-\\d{4})|(?i)(positive))([^.]*)).txt$");
