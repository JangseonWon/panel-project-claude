...
@Service("Cancer-SnvCount ver.1.1")
public class SnvCountv1_1 extends SnvCountWorker {
	...
	private static final Pattern SERIAL_PATTERN = Pattern.compile("^((\\d{2}(?:OS-)*Cancer\\d{1,4})[-_]((\\d{2}(\\D+)\\d{1,4}.*)|([^-]*)[-_])?(\\d{1,4})*[-_]((\\d{8}-\\d{3}-\\d{4})|(?i)(positive))([^.]*)).annotation.txt$");
	...
	public SnvCountv1_1(AnalysisDAO dao) {
		super(dao);
		this.dao = dao;
	...
	@Override
	public String name() {
		return "Cancer-SnvCount ver.1.1";
	}
