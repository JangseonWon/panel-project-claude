...
public class LimsStatv3 implements Worker {
	...
	private static final Pattern SERIAL_PATTERN = Pattern.compile("^((\\d{2}(BRCA)\\d{1,4})[_-]([A-Za-z0-9]+)-(\\d{1,4})[_-](\\d{8}-\\d{3}-\\d{4}))");
