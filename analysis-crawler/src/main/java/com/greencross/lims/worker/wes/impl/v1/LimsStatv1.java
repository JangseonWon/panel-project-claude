...
public class LimsStatv1 implements Worker {
	...
	private static final Pattern SERIAL_PATTERN = Pattern.compile("^(\\d{2}WES\\d{1,4})(-RE)*[-_]((\\d{8}-\\d{3}-\\d{4})|(?i)(.+))[-_](.+)[-_](\\d{1,4})(.*)$");
	...
	public Analysis analysis(String fileName, @Nullable Request request) {
		...
		String panel = "WES";
		UUID sheet = m.group(6).equalsIgnoreCase("WES") ? SHEET_WES : SHEET_RD;
