...
@Service("BRCA-SNV ver.1.1")
public class SnvAllv1_1 extends SnvWorkerImpl {
	private static final Pattern FILE_NAME_PATTERN = Pattern.compile("^(I_(\\d{2}BRCA\\d{1,4})[-_](\\d{1,4})(([-_]\\d{2}(.*)[-_]\\d{1,4})|[-_]\\d{2}(\\D+)\\d{1,4})*.*[-_]((\\d{8}-\\d{3}-\\d{4})|(?i)(positive))([^.]*)).annotation.txt$");
	...
	public SnvAllv1_1(ElasticsearchRestTemplate em, SnvCandidateDAO candidateDao, SnvConsensualClassDao consensualDao, RequestDAO requestDAO, ObjectMapper om) {
