...
public class Depthv2 extends DepthWorkerImpl {
	private static final Pattern FILE_NAME_PATTERN = Pattern.compile("^Depth_exon.merge.((\\d{2}([A-Z]+)\\d{1,4})(-RE)*[-_]((\\d{8}-\\d{3}-\\d{4})|(?i)(.+))[-_](.+)[-_](\\d{1,4})(.*)).txt$");
	...
	public static final DepthWorkerImpl.Process PROCESSOR = new DepthWorkerImpl.Process() {
		@Override
	...
	public Depthv2(ElasticsearchRestTemplate em, RequestDAO requestDAO, ObjectMapper om) {
