...
@Service("GMD-SNV-MT-Candidates ver.2")
public class SnvMtCandidatesv2 extends SnvWorkerImpl {
	private static final Pattern FILE_NAME_PATTERN = Pattern.compile("^((\\d{2}([A-Z]+)\\d{1,4})(-RE)*[-_]((\\d{8}-\\d{3}-\\d{4})|(?i)(.+))[-_](.+)[-_](\\d{1,4})(.*))_[MI]_MT.annotation_filter.txt$");
	...
	@Override
	public String name() {
		return "GMD-SNV-MT-Candidates ver.2";
	}
	@Override
