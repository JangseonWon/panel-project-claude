...
import com.greencross.lims.worker.brca.impl.v2.LimsStatv2;
...
public class LimsStatv3Test {
    @Mock
    private RequestDAO requestDAO;
    @InjectMocks
    private LimsStatv2 limsStatv2;
    private final Logger Log = LoggerFactory.getLogger(getClass());

    private final static Tester Z137_01 = new TesterImpl("21BRCA014_20290219-171-5075_21BRCA144-02_I", 202902191715075L,
    ...
    private final static Tester Z137_02 = new TesterImpl("21BRCA014_20290218-171-5075_BRCA-1_I", 202902181715075L,
    ...
    private final static Tester Z138_01 = new TesterImpl("21BRCA014_20290219-171-5075_21BRCA144-02_I", 202902191715075L,
    ...
    private final static Tester Z138_02 = new TesterImpl("21BRCA014_20290218-171-5075_BRCA-1_I", 202902181715075L,
    ...
    private final static Tester X009_01 = new TesterImpl("21BRCA015_20290222-171-5289_21TP53-006-17_I", 202902221715289L,
    ...
    private final static Tester X009_02 = new TesterImpl("21BRCA015_20290222-171-5289_BRCA-1_I", 202902221715289L,
            new Request().pk(new Request.RequestPK().sample(202902221715289L).service("X009")),
    ...
    private final static Tester G068_01 = new TesterImpl("21BRCA012_20290209-171-5213_21cele-B021-07_I", 202902091715213L,
    ...
    private final static Tester G068_02 = new TesterImpl("21BRCA012_20290209-171-5213_BRCA-1_I", 202902091715213L,
            new Request().pk(new Request.RequestPK().sample(202902091715213L).service("G068")),
    ...
    private final static Tester G069_01 = new TesterImpl("21BRCA012_20290209-171-5213_21cele-B021-07_I", 202902091715213L,
    ...
    private final static Tester G069_02 = new TesterImpl("21BRCA012_20290209-171-5213_BRCA-1_I", 202902091715213L,
            new Request().pk(new Request.RequestPK().sample(202902091715213L).service("G069")),
            new Analysis(new Analysis.AnalysisPK(UUID.fromString("a118c948-74b9-4929-abf9-35d8a50e6f37"), "21BRCA012", 1, "202902091715213:G069"))
                    .panel("BRCA").serial("21BRCA012_20290209-171-5213_BRCA-1_I")
                    .sample(202902091715213L).service("G069"));
    private final static Tester N001_01 = new TesterImpl("21BRCA012_20290210-171-5049_21W-BRCA012-06_I", 202902101715049L,
    ...
    private final static Tester N001_02 = new TesterImpl("21BRCA012_20290210-171-5049_BRCA-1_I", 202902101715049L,
            new Request().pk(new Request.RequestPK().sample(202902101715049L).service("N001")),
    ...
    private final static Tester N101_01 = new TesterImpl("21BRCA012_20290210-100-5213_21CGS007-14_I", 202902101005213L,
    ...
    private final static Tester N101_02 = new TesterImpl("21BRCA012_20290210-100-5213_BRCA-1_I", 202902101005213L,
            new Request().pk(new Request.RequestPK().sample(202902101005213L).service("N101")),
    ...
    private final static Tester N111_01 = new TesterImpl("21BRCA012_20290210-100-5213_21CGS007-14_I", 202902101005213L,
    ...
    private final static Tester N111_02 = new TesterImpl("21BRCA012_20290210-100-5213_BRCA-1_I", 202902101005213L,
            new Request().pk(new Request.RequestPK().sample(202902101005213L).service("N111")),
    ...
    void testSample() {
        for(Tester test: TESTERS) {
            Log.info(test.input());
            test.testSampleExtract(limsStatv2.sample(test.input()));
    ...
    void testAnalysis() {
        for(Tester test: TESTERS) {
            Log.info(test.input());
            test.testAnalysisExtract(limsStatv2.analysis(test.input(), test.requestSample()));
        }
    }
}
