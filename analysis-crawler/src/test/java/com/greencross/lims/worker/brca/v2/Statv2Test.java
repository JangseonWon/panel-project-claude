...
import com.greencross.lims.worker.brca.impl.v2.Statv2;
...
public class Statv2Test {
    ...
    void testSample() {
        for(Tester test: TESTERS) {
            Log.info(test.input());
            test.testSampleExtract(statv2.sample(test.input()));
        }
    }
    @Test
    ...
    void testAnalysis() {
        for(Tester test: TESTERS) {
            Log.info(test.input());
            test.testAnalysisExtract(statv2.analysis(test.input(), test.requestSample()));
        }
    }
}
