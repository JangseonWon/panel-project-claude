...
public class S051CollapseElement extends HTMLElementBuilder<HTMLDivElement, S051CollapseElement> implements CollapseElement<HTMLDivElement> {
	public static S051CollapseElement build(String id, long sample, String service) {
		return new S051CollapseElement(div(), id, sample, service);
	}
	...
	private S051CollapseElement(HTMLContainerBuilder<HTMLDivElement> e, String id, long sample, String service) {
	...
	public void update() {
		...
		InterpretationApi.interpretation(sample, service).then(reports->{
			this.update((S051Dto)reports);
			return null;
		});
	}

	private void update(S051Dto dto) {
		meta.element().innerHTML = "";
	...
	@Override
	public S051CollapseElement that() {
		return this;
	}
