...
public class CancerExpandElement extends PanelExpandElement {
	public static CancerExpandElement build(String id, long sample, String service) {
		return new CancerExpandElement(div(), id, sample, service);
	}
	private CancerExpandElement(HTMLContainerBuilder<HTMLDivElement> e, String id, long sample, String service) {
		super(e, id, sample, service);
	}
	public void auto() {
