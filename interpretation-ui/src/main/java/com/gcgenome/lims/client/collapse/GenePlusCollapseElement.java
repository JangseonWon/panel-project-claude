...
public class GenePlusCollapseElement extends HTMLElementBuilder<HTMLDivElement, GenePlusCollapseElement> implements CollapseElement<HTMLDivElement> {
	public static GenePlusCollapseElement build(String id, long sample, String service) {
		return new GenePlusCollapseElement(div(), id, sample, service);
	}
	...
	private GenePlusCollapseElement(HTMLContainerBuilder<HTMLDivElement> e, String id, long sample, String service) {
	...
	public void update() {
		...
		InterpretationApi.interpretation(sample, service).then(reports->{
			this.update((PanelTest)reports);
			return null;
		});
	}

	private void update(PanelTest dto) {
		meta.element().innerHTML = "";
	...
	@Override
	public GenePlusCollapseElement that() {
		return this;
	}
