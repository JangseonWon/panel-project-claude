...
public class PanelCollapseElement extends HTMLElementBuilder<HTMLDivElement, PanelCollapseElement> implements CollapseElement<HTMLDivElement> {
	public static PanelCollapseElement build(String id, long sample, String service) {
	...
	private PanelCollapseElement(HTMLContainerBuilder<HTMLDivElement> e, String id, long sample, String service) {
