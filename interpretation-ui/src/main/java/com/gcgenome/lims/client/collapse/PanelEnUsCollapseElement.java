...
public class PanelEnUsCollapseElement extends HTMLElementBuilder<HTMLDivElement, PanelEnUsCollapseElement> implements CollapseElement<HTMLDivElement> {
	public static PanelEnUsCollapseElement build(String id, long sample, String service) {
		return new PanelEnUsCollapseElement(div(), id, sample, service);
	}
	...
	private PanelEnUsCollapseElement(HTMLContainerBuilder<HTMLDivElement> e, String id, long sample, String service) {
	...
	@Override
	public PanelEnUsCollapseElement that() {
		return this;
	}
