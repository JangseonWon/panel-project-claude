...
@RestController
public class LibraryAnalysisController {
	private final LibraryAnalysisService svc;
	public LibraryAnalysisController(LibraryAnalysisService svc) {
		this.svc = svc;
	}
	@RequestMapping(value="/library/batches/{batch}/analysis", method= RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseStatus(HttpStatus.OK)
	public List<Analysis> analysis(@PathVariable int batch, @RequestBody Query query) {
		return svc.list(batch, query);
	}
	@RequestMapping(value="/library/batches/{batch}/analysis/last-row", method= RequestMethod.GET)
	@ResponseStatus(HttpStatus.OK)
	public int findLastRow(@PathVariable int batch) {
		return svc.findLastRow(batch);
	}
	@RequestMapping(value="/library/batches/{batch}/analysis/{row}", method= RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseStatus(HttpStatus.OK)
	...
	@RequestMapping(value="/library/batches/{batch}/analysis/{row}", method= RequestMethod.PATCH, produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseStatus(HttpStatus.OK)
	...
	@RequestMapping(value="/library/batches/{batch}/analysis/{row}", method= RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseStatus(HttpStatus.OK)
