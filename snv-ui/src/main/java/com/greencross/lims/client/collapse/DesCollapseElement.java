...
public class DesCollapseElement extends HTMLElementBuilder<HTMLDivElement, DesCollapseElement> implements CollapseElement<HTMLDivElement> {
	public static DesCollapseElement build(String id, long sample, String service) {
		return new DesCollapseElement(div(), id, sample, service);
	}
	...
	private DesCollapseElement(HtmlContentBuilder<HTMLDivElement> e, String id, long sample, String service) {
	...
	@Override
	public DesCollapseElement that() {
		return this;
	}
