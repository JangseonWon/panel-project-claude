...
public class Sheet {
	...
	@Type(type="com.gcgenome.lims.entity.udt.ColumnsConverter")
	private com.gcgenome.lims.dto.Sheet.ColumnDefinition[] columns;
	@Column(name="event_handlers", columnDefinition="jsonb")
	@Type(type="com.gcgenome.lims.entity.udt.EventHandlerConverter")
	private com.gcgenome.lims.dto.Sheet.EventHandler[] handlers;
	@Column(name="active")
