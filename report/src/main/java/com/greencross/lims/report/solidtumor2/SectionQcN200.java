...
public class SectionQcN200 implements SectionQc {
    ...
    public SectionQcN200(Painter<SolidTumorTemplate, SolidTumorDto> newPage) {
    ...
    private PDPageContentStreamPageAccessible summary(PDPageContentStreamPageAccessible stream, SolidTumorTemplate template, SolidTumorDto dto) throws IOException {
        ...
        stream.paragraph(343f, y, 126, CENTER, MIDDLE, new TextBlock(resource.styleHeader(), "MSI"));
        stream.paragraph(469.5f, y, 127, CENTER, MIDDLE, new TextBlock(resource.styleHeader(), "Tumor purity"));
        y -= 21;
        var result = dto.qc();
        ...
        y = Math.min(y, stream.paragraph(343f, y, 126, CENTER, WhiteSpace.BREAK_ALL, new TextBlock(resource.styleValueTable(), dto.qc().msiQc())));
        y = Math.min(y, stream.paragraph(469.5f, y, 127, CENTER, WhiteSpace.BREAK_ALL, new TextBlock(resource.styleValueTable(), fmtNumber.format(dto.qc().purity()) + "%")));
