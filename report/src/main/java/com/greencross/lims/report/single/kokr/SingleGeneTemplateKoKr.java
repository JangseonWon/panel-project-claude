...
public final class SingleGeneTemplateKoKr implements SingleGeneTemplate {
	...
	private final SingleGeneResource resource;
	private final TestInfo testInfo;
	private final LogoType logoType;
	public SingleGeneTemplateKoKr(SingleGeneResource resource, TestInfo testInfo, LogoType logoType) {
		this.logoType = logoType;
		this.resource = resource;
		this.testInfo = testInfo;
	}
	public final SingleGeneResource resource() {
		return resource;
	}
