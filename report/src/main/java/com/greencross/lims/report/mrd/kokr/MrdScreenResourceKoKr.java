...
public class MrdScreenResourceKoKr implements MrdScreenResource {
	...
	public MrdScreenResourceKoKr(PDDocument doc) throws IOException {
		this.doc = doc;
	...
	public Color colorText() {
		return MrdScreenResource.super.colorText();
	}
}
