...
public class DgsHeaderKoKr extends DgsHeader {
	private Color colorGray;
	private TextStyle styleTitle;
	private TextStyle styleHeaderTitle;
	private TextStyle styleValueTitle;
	private TextStyle styleTextSign;

	public DgsHeaderKoKr(DgsTemplate template) {
		super(template);
	}
	...
	public Painter<DgsTemplate, DgsDto> initialize() {
		return (stream, template, dto) -> {
			...
			styleValueTitle = new TextStyle().color(resource.colorText()).fonts(resource.fontText2(), resource.fontDefault()).fontSize(7).paragraph(false);
			styleTextSign = new TextStyle().color(resource.colorText()).fonts(resource.fontText1(), resource.fontText2(), resource.fontDefault()).fontSize(9).justify(false).paragraph(false);
			return stream;
		};
	}
	...
	public Painter<DgsTemplate, DgsDto> sign() {
