...
public class DgsResourceEnUs implements DgsResource {
	...
	public DgsResourceEnUs(PDDocument doc, DgsDto dto) throws IOException {
		this.doc = doc;
		...
		inspector = DgsResourceEnUs.this.person("류해인") ;
