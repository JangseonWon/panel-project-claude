...
public class GenomeScreenResourceN101KoKr extends GenomeScreenResourceKoKr {
	private final Color colorPrimary = Color.decode("#14604F");
	...
	public GenomeScreenResourceN101KoKr(PDDocument doc) throws IOException {
		super(doc);
		fontDefault	= font(new File(GenomeScreenResource.resource, "font/NanumBarunGothic.ttf"));

		File img	= new File(GenomeScreenResource.resource, "img/genomescreen/N101/KoKr");
