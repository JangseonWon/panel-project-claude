...
import com.greencross.lims.report.wes.WesHeader;
...
public class WesHeaderKoKr extends WesHeader {
	private Color colorGray;
	private TextStyle styleTitle;
	private TextStyle styleHeaderTitle;
	private TextStyle styleValueTitle;
	public WesHeaderKoKr(WesTemplate template) {
		super(template);
	}

	@Override
	public Painter<WesTemplate, WesDto> initialize() {
	...
	@Override
	public Painter<WesTemplate, WesDto> header() {
		return (stream, template, dto) -> {
