...
import com.greencross.lims.report.geneplus.GenePlusTemplate;
import lombok.Data;
...
public final class GenePlusTemplateKoKr implements GenePlusTemplate {
	...
	private final GenePlusResource resource;
	private final TestInfo testInfo;
	private final LogoType logoType;
	public GenePlusTemplateKoKr(GenePlusResource resource, TestInfo testInfo, LogoType logoType) {
		this.logoType = logoType;
		this.resource = resource;
		this.testInfo = testInfo;
	}
	public final GenePlusResource resource() {
		return resource;
	}
