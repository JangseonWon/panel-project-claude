...
import com.greencross.lims.report.genomescreen.RiskScreenResourceN087;
...
public class GenomeScreenResourceN087KoKr extends GenomeScreenResourceKoKr implements RiskScreenResourceN087 {
	private final Color colorPrimary = Color.decode("#8360A0");
	private final PDFont fontDefault;
	private final File img						= new File(GenomeScreenResource.resource, "img/genomescreen/N087/KoKr");
	...
	public GenomeScreenResourceN087KoKr(PDDocument doc) throws IOException {
		super(doc);
