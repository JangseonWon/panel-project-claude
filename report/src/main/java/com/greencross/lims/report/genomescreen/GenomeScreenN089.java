...
public class GenomeScreenN089 extends GenomeScreenPageBuilder<GenomeScreenTemplateN089<GenomeScreenResource>> {
	protected final Painter<GenomeScreenTemplate<GenomeScreenResource>, GenomeScreenDto> barcode = new SectionBarcode<>();
	...
	protected final Painter<GenomeScreenTemplate<GenomeScreenResource>, GenomeScreenDto> empty = (s, t, d)->newPage(s);
	...
	public GenomeScreenN089(GenomeScreenTemplateN089 template, GenomeScreenDto dto,
	...
	public Painter<GenomeScreenTemplate<GenomeScreenResource>, GenomeScreenDto> pages() {
		...
		.and((s, t, d)->newPage(s)).and(template()).and(infos).and(references).and(clinicalMeanings).and((stream, template, dto)->{
					stream.font(template.resource().fontDefault());
					return stream;
				}).and(ldt).and(page);
	}
