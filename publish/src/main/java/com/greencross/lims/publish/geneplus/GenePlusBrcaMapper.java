...
public class GenePlusBrcaMapper implements AlisMapper<PanelTest> {
	...
	public boolean match(Request request) {
		...
		return Arrays.stream(TestInfo.TESTS_BRCA).anyMatch(m -> m.code().equalsIgnoreCase(service));
	}
	...
	public AlisVariantResult[] variants(Request request, PanelTest interpretation, Class<PanelTest> clazz) {
		List<AlisVariantResult> values = new ArrayList<>();
